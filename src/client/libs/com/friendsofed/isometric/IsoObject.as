package com.friendsofed.isometric
{
	...
	public class IsoObject extends Sprite
	{
		...
		public function IsoObject(size:Number,__sprite:IsoSprite=null)
		{
			_size = size;
		...
		public function get positionNodePoint():Point {
			var p:Point = new Point(x / _size, z / _size);
			return p;
		}
		 ...
		 * 更新位置数据
		 */
		private function updataIsoPosition():void {
			var isoPos:Point3D = IsoUtils.screenToIso(new Point(super.x, super.y));
			_position = isoPos;
		}
		...
		public function get depth():Number
		{
			...
			//return (_position.x + _position.z) * .866 - _position.y * .707- height * .05 +width * .02;
		}
		
		public function get moreDepth():Number {
			return - height * .1 +width * .2 + sortPriority;
		}
