 ...
 */
class MyLib_Zend_Controller_Router_Route_Regex implements Zend_Controller_Router_Route_Interface
{
    ...
    public function match($path)
    {
        ...
        //$values = $this->_getMappedValues($value1);
        $values = $this->_getMappedValues($values);
        
        $defaults = $this->_getDefaultedValues($value2);
    ...
    protected function _getDefaultedValues($values)
    {
        $return = array();
