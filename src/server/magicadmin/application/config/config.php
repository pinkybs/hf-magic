...
$config['path_source'] = $config['site_domain'].$config['resource'];
$config['path_img'] = $config['site_domain'].$config['resource'].'img/';
$config['path_js'] = $config['site_domain'].$config['resource'].'js/';
$config['path_fcharts'] = '/'.$config['resource'].'Charts/';