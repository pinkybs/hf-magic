...
class Happyfish_Magic_Dal_Mongo_UserLoginInfo extends Happyfish_Magic_Dal_Mongo_Abstract
{
	/**
     * user table name
     *
     * @var string
     */
    protected $_tableName = 'user_login_info';
     ...
     * single instance
     *
     * @return Happyfish_Magic_Dal_Mongo_UserLoginInfo
     */
